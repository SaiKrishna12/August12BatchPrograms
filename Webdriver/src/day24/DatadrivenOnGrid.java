...
public class DatadrivenOnGrid {
	...
	public void linksTest(String b) throws IOException
	{
		...
		FileInputStream f=new FileInputStream("E:\\August12Batch\\Webdriver\\src\\com\\qedge\\excelfiles\\links.xlsx");
		...
		FileOutputStream f1=new FileOutputStream("E:\\August12Batch\\Webdriver\\src\\com\\qedge\\resultexcelfiles\\"+b+"_links.xlsx");
		wb.write(f1);
		f1.close();
