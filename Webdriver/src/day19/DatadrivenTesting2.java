...
public class DatadrivenTesting2 {
	...
	{
		FileInputStream f=new FileInputStream("E:\\August12Batch\\Webdriver\\src\\com\\qedge\\excelfiles\\registration.xlsx");
		...
		FileOutputStream f1=new FileOutputStream("E:\\August12Batch\\Webdriver\\src\\com\\qedge\\resultexcelfiles\\registration.xlsx");
		wb.write(f1);
		f1.close();
		driver.quit();
	}
